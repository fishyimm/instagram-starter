...
public class UserFeedActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final LinearLayout linearLayout = (LinearLayout)findViewById(R.id.scrollLinearLayout);
...
//                                        imageView.setScaleType(ImageView.ScaleType.FIT_CENTER);
                        ...
                        Toast.makeText(UserFeedActivity.this, "This feed is empty ", Toast.LENGTH_SHORT).show();
                    }
                } else {
